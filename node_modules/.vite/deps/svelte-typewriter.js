import {
  loopOnce_default
} from "./chunk-FKKLIVPJ.js";
import {
  loopRandom_default
} from "./chunk-KLB54AGJ.js";
import {
  scramble_default
} from "./chunk-HNRE6RZZ.js";
import {
  concurrent_default
} from "./chunk-BMGQJZAT.js";
import {
  cascade_default
} from "./chunk-SK3P22T6.js";
import {
  loop_default
} from "./chunk-U3OOPMLS.js";
import "./chunk-CLYPAUN7.js";
import "./chunk-GE42BDYS.js";
import "./chunk-YLKCOFAB.js";
import "./chunk-QZ5GCI5V.js";
import "./chunk-XBX55Z67.js";
import "./chunk-HV5IDF5I.js";
import {
  SvelteComponentDev,
  action_destroyer,
  add_location,
...
// node_modules/.pnpm/svelte-typewriter@3.2.0_svelte@4.2.2/node_modules/svelte-typewriter/package/Typewriter.svelte
var file = "node_modules/.pnpm/svelte-typewriter@3.2.0_svelte@4.2.2/node_modules/svelte-typewriter/package/Typewriter.svelte";
function add_css(target) {
  append_styles(target, "svelte-fi9az1", "@keyframes svelte-fi9az1-cursorFade{0%,100%{opacity:1}50%{opacity:0}}.typewriter-container.svelte-fi9az1 *:not(.typing):not(.finished-typing):not([data-static]){display:none}.typewriter-container.svelte-fi9az1 .finished-typing::after{content:none}.cursor.svelte-fi9az1 .typing::after{content:'';width:var(--cursor-width, 1ch);height:2ch;display:inline-block;vertical-align:text-top;background-color:var(--cursor-color, #000000);animation:svelte-fi9az1-cursorFade 1.25s infinite}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
...
function create_if_block(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(div, "class", "typewriter-container svelte-fi9az1");
      add_location(div, file, 99, 8, 3231);
    },
    m: function mount(target, anchor) {
...
function create_then_block_1(ctx) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "then",
    source: "(112:52)                  <svelte:element this={element}",
    ctx
  });
  return block;
}
function create_dynamic_element(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      set_dynamic_element_data(
        ...
        class: "typewriter-container svelte-fi9az1"
      });
      toggle_class(
        svelte_element,
        "cursor",
      ...
      add_location(svelte_element, file, 111, 16, 3609);
    },
    m: function mount(target, anchor) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    source: '(113:16) <svelte:element this={element} use:selectedMode.default={props} class:cursor class=\\"typewriter-container\\">',
    ctx
  });
  return block;
}
...
function create_pending_block(ctx) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "pending",
    source: "(105:31)              {#if showCursorOnDelay}",
    ctx
  });
  return block;
}
function create_if_block_1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(p, file, 106, 20, 3460);
      attr_dev(div, "class", "typewriter-container cursor svelte-fi9az1");
      add_location(div, file, 105, 16, 3398);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, div, anchor);
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "if",
    source: "(106:12) {#if showCursorOnDelay}",
    ctx
  });
  return block;
}
...
function instance($$self, $$props, $$invalidate) {
  ...
  const modes = {
    concurrent: () => import("./concurrent-P6XHSI3D.js"),
    cascade: () => import("./cascade-5RVRMSON.js"),
    loop: () => import("./loop-4RU6ZC5V.js"),
    loopOnce: () => import("./loopOnce-V5C6SJUT.js"),
    loopRandom: () => import("./loopRandom-CJEBHQPA.js"),
    scramble: () => import("./scramble-T3Q6XBO6.js")
  };
  $$self.$$set = ($$new_props) => {
