...
.hljs ::selection{background-color:#6A7D89;color:#C5D4DD}.hljs-comment,.hljs-tag{color:#899BA6}.hljs-subst,
.hljs-punctuation,
...
.hljs-title.class_,.hljs-strong{color:#A8CE93}.hljs-strong{font-weight:bold}.hljs-code,
.hljs-addition,
...
.hljs-template-tag,
.diff .hljs-meta,
.hljs-keyword,.hljs-emphasis{color:#9A93E1}.hljs-emphasis{font-style:italic}.hljs-meta,
