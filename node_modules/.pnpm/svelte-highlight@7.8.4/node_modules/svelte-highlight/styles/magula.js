const magula = `<style>pre code.hljs{display:block;overflow-x:auto;padding:1em}code.hljs{padding:3px 5px}
/*
...
*/.hljs{background-color:#f4f4f4}.hljs,.hljs-subst{color:black}.hljs-string,
.hljs-title,
.hljs-symbol,
.hljs-bullet,
.hljs-attribute,
