...
.hljs-title.class_,.hljs-strong{color:#f29df2}.hljs-strong{font-weight:bold}.hljs-code,
.hljs-addition,
...
.hljs-template-tag,
.diff .hljs-meta,
.hljs-keyword,.hljs-emphasis{color:#7e5ce6}.hljs-emphasis{font-style:italic}.hljs-meta,
